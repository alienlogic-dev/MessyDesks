    ...
    function connectable(options, elmTarget) {
        ...
        con.computeConnectorCoordinates = function (con) {
            ...
            if(con.sourceAttach == 'center') {
                ...
                var arr1 = [
                    ['M', sPos.cx, sPos.y],
                    ['L', sPos.x + sPos.width, sPos.cy],
                    ['L', sPos.cx, sPos.y + sPos.height],
                    ['L', sPos.x, sPos.cy]
                ]
                var arr = arr1
                var point = 'point2'
            ...
            if(con.targetAttach == 'center') {
                ...
                var arr2 = [
                    ['M', tPos.cx, tPos.y],
                    ['L', tPos.x + tPos.width, tPos.cy],
                    ['L', tPos.cx, tPos.y + tPos.height],
                    ['L', tPos.x, tPos.cy]
                ]
                var arr = arr2
                var point = 'point1'
            ...
            if(con.type == 'curved'){
                ...
                /*
                var c1 = {x: sPos.cx(), y: sPos.cy()}
                var c2 = {x: tPos.cx(), y: tPos.cy()}
